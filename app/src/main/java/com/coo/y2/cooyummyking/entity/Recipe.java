...
public class Recipe implements Serializable{
    ...
    public static final String RECIPE_DSCRPT = "description";
    ...
    // [Tuning] 안드로이드에선 게터 세터가 성능면에서 좋지 않기때문에 직접접근으로 한다.
    public int id;
    public int userId;
    ...
    public static Recipe build(JSONObject json) {
        ...
        recipe.description = json.optString(RECIPE_DSCRPT);
    ...
    public String getImageUrl() {
        return URL.getBaseUrl() + "recipes/" + id + "/images/" + mainImageNum;
    }
}
